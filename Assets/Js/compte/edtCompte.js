...
export async function setupEDT(){
    ...
    try{
        ...
        console.error("Erreur setupEDT >>> \n " + err);
        afficherPopup("Erreur setupEDT", err.stack);
    }
    ...
    fetch(jsonUrl)
            ...
            .then(jsonData => {
                ...
                try{
                    ...
                    console.error("Erreur setupEDT/ readJson >>> \n " + err);
                    afficherPopup("Erreur setupEDT/ readJson", err.stack);
                }
            })
...
function intensifyColor(hexColor, factor) {
    try{
        ...
        console.error("Erreur intensifyColor >>> \n " + err);
        afficherPopup("Erreur intensifyColor", err.stack);
    }
}
...
function formatTime(timestamp) {
    try{
        ...
        console.error("Erreur formatTime >>> \n " + err);
        afficherPopup("Erreur formatTime", err.stack);
    }
}
...
function calculateTimeGap(endTime, nextStartTime) {
    try{
        ...
        console.error("Erreur calculateTimeGap >>> \n " + err);
        afficherPopup("Erreur calculateTimeGap", err.stack);
    }
}